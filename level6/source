...
int main(int argc, char **argv) {
    ...
    int (**fun)() = (int (**)())malloc(sizeof(void*)); //note: sizeof(void*) is not in the asm, but one could assume this was the intention (we are in 32 bits, so a pointer is 4 bytes)
